          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-20">
              <div className="max-w-4xl mx-auto text-center">
                ...
                {/* Subheadline */}
                <p 
                  className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-light leading-relaxed max-w-2xl mx-auto mb-6 opacity-0 animate-fade-in"
                ...
                {/* Credibility signals */}
                <p 
                  className="text-sm text-muted-foreground mb-10 md:mb-14 opacity-0 animate-fade-in"
                ...
                >
                  <Link to="/international">
                    <Button
                      size="lg"
                      className="btn-premium bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-base font-medium tracking-wide w-full sm:w-auto"
                    >
                  ...
                  <Link to="/fi">
                    <Button
                      size="lg"
                      variant="outline"
                      className="btn-premium px-8 py-6 text-base font-medium tracking-wide w-full sm:w-auto border-border hover:bg-secondary"
                    >
